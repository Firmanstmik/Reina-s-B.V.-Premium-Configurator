...
const TYPES = [
  { id: "schuifpui", name: "Schuifpui", icon: PanelTop, dim: "4500 x 2200 mm", cols: 4, rows: 1 },
  { id: "kozijn", name: "Kozijn", icon: Square, dim: "1800 x 1400 mm", cols: 2, rows: 2 },
  { id: "voordeur", name: "Voordeur", icon: DoorOpen, dim: "1100 x 2300 mm", cols: 1, rows: 3 },
  { id: "panorama", name: "Panorama", icon: Maximize2, dim: "6000 x 2400 mm", cols: 6, rows: 1 },
] as const;
...
export function ConfiguratorPresentation() {
                    ...
                    <div className="relative flex items-end justify-between">
                      <div>
                        ...
                        <p className="font-display mt-1.5 text-3xl font-medium tracking-tight">
                          EUR {price.toLocaleString("nl-NL")}
                        </p>
              ...
              <div className="relative min-h-[420px] w-full overflow-hidden md:min-h-[490px] xl:min-h-[560px]">
                ...
                <div
                  ...
                  style={{
                    ...
                    opacity: styleMood.washOpacity * 0.22,
                  }}
                />
                ...
                <div
                  ...
                  style={{
                    ...
                    mixBlendMode: "multiply",
                    opacity: colorMood.shadowOpacity * mat.shadowMul * 0.28,
                  }}
                />
                <div
                  aria-hidden
                ...
                <div
                  ...
                  style={{
                    ...
                    opacity: Math.min(0.38, mood.vignette * styleMood.vignetteMul * 0.54),
                  }}
                />
                <div className="pointer-events-none absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-background/32 via-background/6 to-transparent" />
                  ...
                  <div className="flex min-w-0 flex-1 items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <p className="text-[10px] tracking-[0.08em] text-muted-foreground/78">
                        Uw samenstelling /{" "}
                        <span className="text-primary">EUR {price.toLocaleString("nl-NL")}</span>
                      </p>
